...
public class FruitAdapter  extends RecyclerView.Adapter<FruitAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull FruitAdapter.ViewHolder holder, int position) {
        ...
        if (fruit.getImage().size() > 1) {
            int lastIndex = fruit.getImage().size() - 1;
            // Nếu danh sách có nhiều hơn 1 phần tử, hiển thị ảnh từ vị trí thứ 1
            String url = fruit.getImage().get(lastIndex);
            // Thực hiện hiển thị ảnh tại đây
            ...
            // Nếu danh sách có 1 phần tử hoặc không có phần tử nào, hiển thị ảnh từ vị trí thứ 0
